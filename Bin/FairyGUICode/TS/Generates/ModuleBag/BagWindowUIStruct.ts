...
{
	public m_showItemInfo : fgui.Controller;
	public m_showInfoDialog : fgui.Controller;
	public m_itemList : fgui.GList;
	...
	protected onConstruct(): void 
	{
		...
		this.m_itemList = <fgui.GList><any>(this.getChild("itemList"));
